...
int main() {
    ...
    Shader objectShader("Shaders/15.MappedMaterials/15.1.MappedMaterial.vs", "Shaders/15.MappedMaterials/15.1.MappedMaterial.fs");
    objectShader.use();
    //material properties
    ...
    objectShader.setVec3("light.ambientStrength", 0.4f, 0.4f, 0.4f);
